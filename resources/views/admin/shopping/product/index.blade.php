        ...
        <article class='col-md-12 col-sm-5 col-md-5 col-lg-12'>
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="true" data-widget-custombutton="false">
                <header class="clearfix">
                    ...
                    <a href="{{ route($base_route.'.create') }}" title="{{ trans('general.button.add') }}" class="btn-xs-fixed pull-right btn-sm btn btn-labeled btn-primary"> <span
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="datatable" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            @if($data->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td  style="text-align: center;">
                                            @if($row->is_perishable == 1)
                                                <a href="{{route($base_route. '.set-perishable',['id'=>$row->primary_key])}}" class="fa fa-check-square-o" data-toggle="tooltip" title="Make Normal"> &nbsp; </a>
                                            @else
                                                <a href="{{route($base_route. '.set-perishable',['id'=>$row->primary_key])}}" class="fa fa-square-o" data-toggle="tooltip" title="Make Perishable"> &nbsp; </a>
                                            @endif
                                        </td>
                                        <td  style="text-align: center;">
                                            @if($row->is_special == 1)
                                                <a href="{{route($base_route. '.set-special',['id'=>$row->primary_key])}}" class="fa fa-check-square-o" data-toggle="tooltip" title="Make Normal"> &nbsp; </a>
                                            @else
                                        ...
                                        <td style="text-align: center;">
                                            @if($row->is_featured == 1)
                                                <a href="{{route($base_route. '.set-featured',['id'=>$row->primary_key])}}" class="fa fa-check-square-o" data-toggle="tooltip" title="Make Normal"> &nbsp; </a>
                                            @else
                                ...
                                <tfoot>
                                <tr>
                                    <td align="right" colspan="8">{!! $data->render() !!}</td>
                                </tr>
                                </tfoot>
                            @endif
